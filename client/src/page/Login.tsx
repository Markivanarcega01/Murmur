      ...
      <Grid2 container sx={{ height: "100vh", bgcolor:"#E2E8F0"}}>
        <Grid2 size={{ xs: 12, md: 7 }} sx={{display: "flex", justifyContent: "center", alignItems:{xs:"end", md:"center"}, marginBottom:"20px"}}>
          <Grid2 size={{xs: 6, md:7}}>
            <Typography sx={{fontSize:{xs:"50px", md:"70px"}, fontWeight:"bold", textAlign:{xs:"center", md:"start"}}}  color="primary">Murmur</Typography>
            <Typography sx={{fontSize:{xs:"20px", md:"25px"}, opacity: 0.8, textAlign:{xs:"center", md:"start"}, textWrap:{xs:"wrap", md:"nowrap"} }} color="textSecondary">Connect with friends and the world around you on Murmur</Typography>
          </Grid2>
        </Grid2>
